...
import LoginButton from "@/components/header/LoginRegisterButtons/LoginButton1";
import RegisterButton from "@/components/header/LoginRegisterButtons/RegisterButton1";
